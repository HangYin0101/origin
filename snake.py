...
def runGame():
    ...
    while True:  # main game loop
                ...
                if (event.key == K_LEFT) and direction != RIGHT:
                    ...
                    if direction == UP:
                        ...
                        for i in range(len(wormCoords)):
                            new_coor = {'x': wormCoords[i]['x'],
                                       'y': wormCoords[i]['y'] - 5}
                            new_wormCoords.insert(0, new_coor)
                    if direction == DOWN:
                        new_wormCoords = []
                        for i in range(len(wormCoords)):
                            new_coor = {'x': wormCoords[i]['x'],
        ...
        apple_eaten_list = [wormCoords[HEAD]['x'] == apple_list[i]['x'] and wormCoords[HEAD]['y'] == apple_list[i]['y'] for i in range(len(apple_list))]
